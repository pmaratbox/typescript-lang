// TypeScript — pino level filtering, captured in-memory, normalized. Run: npx tsx main.ts
...
log.info("hidden");   // below the minimum level -> dropped, never written
log.warn("visible");  // at/above the minimum level -> captured
